          ...
          {paginated.map((c, index) => {
            ...
            return (
              <tr key={c._id}>
                ...
                <td className="border p-2 text-center">{c.c_name}</td>
                  ...
                  {remainingEmails.length > 0 && (
                    <div className="absolute left-0 bottom-full mb-1 hidden group-hover:flex gap-2 bg-gray-100 p-2 rounded shadow z-50">
                      {remainingEmails.map((email, i) => (
                        <span key={i} className="px-1 py-0.5 rounded bg-gray-200">
                          {email.trim()}
                        </span>
                      ))}
                    </div>
                ...
                <td className="border p-2 text-center">{c.c_company}</td>
